...
function bindAll(){
 ...
 bindSetting("mapSize",true);["wrap","selfCollision","grid","ghostFood","respawn","nearMiss","perfectBonus","theme","snakeStyle","foodStyle","graceDozer","curseEnabled"].forEach(id=>bindSetting(id,false));
